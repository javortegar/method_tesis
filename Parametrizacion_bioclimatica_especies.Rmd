...
Se realizó la parametrizacion de las tolerancias bioclimaticas de las especies arboreas dominantes para el area de estudio recurriendo a los rangos de distribucion potencial de cada especie descritos por Luebert y Pliscoff (2017), generando un mapa raster con una resolucion espacial de 5 km para cada una de las especies incluidas en las simulaciones, para finalmente generar sobre cada uno de dichos mapas por especie un total de 1000 puntos aleatorios. Por ultimo, se filtraron los puntos que se repetian dentro de la misma celda para cada uno de los mapas de distribucion del conjunto de especies incluidas, buscando representar de forma equitativa la totalidad de la superficie del rango de distribucion potencial de cada especie dejando solo un punto por celda. De esa forma, se busco evitar el sesgo que puede tener en la estimacion de los parametros de tolerancia bioclimatica repetir la misma informacion para una misma celda al coincidir dos o más puntos en esta.
