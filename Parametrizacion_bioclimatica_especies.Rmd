...
Posteriormente, se extrajo desde las bases de datos climaticas CR2Met v1.3 del Centro de Ciencia del Clima y la Resiliencia (CR2) y el reanalisis atmosferico de ERA5-Land del Copernicus Climate Change Service (C3S) (2019), en conjunto con el mapa raster de Bucket size (i.e. disponibilidad de agua del suelo para las plantas) la información climática relacionada con la precipitación mensual, temperatura media mensual y la humedad aprovechable de los suelos presentes en los diferentes mapas de distribucion potencial. Lo cual permitio estimar los parametros que definen las tolerancias bioclimaticas para cada punto dentro del rango de distribucion de cada una de las especies incluidas: la tolerancia a la sequía (kDrTol), mínima de días-grados (kDDMin), temperatura mínima de invierno (kWiTN) y temperatura máxima de invierno (kWiTX).
