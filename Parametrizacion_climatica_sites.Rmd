...
1. Se utilizaron bases de datos climáticos grillados (e.g. ERA5LAND y CR2MET) correspondientes a los registros mensuales de temperatura media y precipitación acumulada, los que a través de una grilla climática con una resolución espacial de 5-10 km permitieron determinar los valores de precipitación y temperatura para el transecto longitudinal, describiendo estas variables del clima tanto para el territorio nacional como para el territorio argentino. El cálculo de los parámetros climáticos se realizó para un rango de 37 años, desde el año 1979 hasta el 2016.
